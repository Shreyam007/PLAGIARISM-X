...
const DragDrop = ({ onFilesDrop, onStartAnalysis }) => {
  ...
  const { getRootProps, getInputProps, isDragActive } = useDropzone({
    onDrop,
    accept: {
      'text/*': ['.js', '.jsx', '.ts', '.tsx', '.py', '.java', '.cpp', '.c', '.cs', '.php', '.rb', '.go', '.txt'],
    ...
    <div style={{
      ...
      >
        ...
        <div
          ...
          style={{
            border: '2px dashed',
            borderColor: isDragActive ? 'var(--primary)' : 'rgba(0, 255, 157, 0.4)',
            borderRadius: '24px',
            padding: '80px 40px',
            cursor: 'pointer',
            transition: 'all 0.3s ease',
            background: isDragActive ? 'rgba(0, 255, 157, 0.08)' : 'rgba(0, 255, 157, 0.02)',
